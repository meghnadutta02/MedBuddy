...
const loadGpayScript = (cartSubtotal, cartItems, orderId, updateStateAfterOrder) => {
    loadScript({"client-id": "your Gpay client id"})
    .then(paypal => {
        paypal
    ...
    .catch(err => {
        console.error("failed to load the Gpay JS SDK script", err);
    })
}
...
const UserOrderDetailsPage = () => {
  ...
  return <UserOrderDetailsPageComponent userInfo={userInfo} getUser={getUser} getOrder={getOrder} loadGpayScript={loadGpayScript} />;
};
